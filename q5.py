...
# Example usage
min_heap = MinHeap()
values_to_insert_min = [4, 2, 7, 1, 9, 3]
for value in values_to_insert_min:
...
max_heap = MaxHeap()
values_to_insert_max = [4, 2, 7, 1, 9, 3]
for value in values_to_insert_max:
    max_heap.insert(value)

print("\nMax Heap after insertion:", max_heap.heap)
